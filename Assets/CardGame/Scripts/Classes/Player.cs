...
public class Player : IPlayer
{
    ...
    private Deck deck;
    private int steamPoints;

    private bool canPlay;

    public Player(string playerName, PlayerType playerType, Deck playerDeck, int steamPoints)
    {
        this.playerName = playerName;
        this.playerType = playerType;
        this.steamPoints = steamPoints;
        hand = new PlayerHand();
    ...
    public int SteamPoints { get => steamPoints; set => steamPoints = value; }
}